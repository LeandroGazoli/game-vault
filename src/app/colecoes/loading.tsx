...
export default function ColecoesLoading() {
  return (
    <div className="space-y-10 pb-16 pt-2 animate-pulse">
      {/* Hero da Página de Coleções Skeleton */}
      <section className="relative rounded-3xl border border-white/10 bg-[#141520] p-8 sm:p-12 shadow-2xl space-y-4">
      ...
      {/* Grid com Coleções Skeleton */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            key={i}
            className="flex flex-col justify-between p-6 rounded-3xl border border-white/10 bg-[#12131d] min-h-[260px] relative overflow-hidden"
          >
