...
import { COLLECTIONS_DATA, getCollectionBySlug } from "@/lib/collectionsData";
...
/**
 * As coleçãos vêm de um arquivo estático do repositório, não do Firestore — então todas as
 * rotas podem ser pré-renderizadas no build. Evita ISR (e a escrita no KV que ele custa).
 */
export async function generateStaticParams() {
  return COLLECTIONS_DATA.map((item) => ({ slug: item.slug }));
}
