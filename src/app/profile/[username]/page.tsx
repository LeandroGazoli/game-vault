...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${cleanUsername} - Perfil Gamer & Backlog | GameVault`,
    ...
    alternates: {
      canonical: `/profile/${encodeURIComponent(cleanUsername)}`,
    },
    robots: {
      index: true,
      follow: true,
    ...
    openGraph: {
      ...
      url: `${SITE_URL}/profile/${encodeURIComponent(cleanUsername)}`,
      siteName: "GameVault",
      type: "profile",
      images: [
        {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: cleanUsername,
          item: `${SITE_URL}/profile/${encodeURIComponent(cleanUsername)}`,
        },
      ],
    },
  ];
