...
export const THEME_STYLES: Record<ProfileTheme, ThemeStyles> = {
  cyan: {
    ...
    activeTabBg: "bg-cyan-950/60 text-[#00E5FF] border border-[#00E5FF]/60 shadow-md shadow-[#00E5FF]/10 font-bold",
  ...
  gold: {
    ...
    activeTabBg: "bg-amber-950/60 text-amber-300 border border-amber-500/60 shadow-md shadow-amber-500/10 font-bold",
  ...
  purple: {
    ...
    activeTabBg: "bg-purple-950/60 text-purple-300 border border-purple-500/60 shadow-md shadow-purple-500/10 font-bold",
  ...
  crimson: {
    ...
    activeTabBg: "bg-rose-950/60 text-rose-300 border border-rose-500/60 shadow-md shadow-rose-500/10 font-bold",
  ...
  emerald: {
    ...
    activeTabBg: "bg-emerald-950/60 text-emerald-300 border border-emerald-500/60 shadow-md shadow-emerald-500/10 font-bold",
