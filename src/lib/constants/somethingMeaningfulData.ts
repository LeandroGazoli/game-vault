import { IndieSubmissionForm } from "../types/indie.types";

/**
 * Dados extraídos do Presskit e Assets do Google Drive:
 * Pasta: 19MWjjn_q1ZgrjMec6rksO1v4tV0HzVjp (Something Meaningful)
 */
...
* CONHEÇA PERSONAGENS ÚNICOS: Interaja com todos e descubra como suas escolhas moldam a jornada.`,
  ...
  trailerUrl: "https://drive.google.com/file/d/15FdJKhDKR39sZqQu-TN6eV6Q2Wsakz1Q/preview",
  ptbrSupport: {
    audio: true,
    subtitles: true,
    interface: true,
  ...
  screenshots: [
    "https://lh3.googleusercontent.com/d/1vdxRcB2VJ_XaKomMA_1z25DljXRJqAPq=w1600",
    "https://lh3.googleusercontent.com/d/11nixbXDFsasXpV8OYv5z1UpGFmjvsFx7=w1600",
    "https://lh3.googleusercontent.com/d/1JFSt0AfNABWM_XHZseG4Guln2F5y7w5t=w1600",
    "https://lh3.googleusercontent.com/d/1LaRNZYd9VIq9pkbeeu83C0gRfXb1AA5j=w1600",
    "https://lh3.googleusercontent.com/d/17GKeLoEd1Rb_eQD8nMF_X6VaS14KxTeT=w1600",
    "https://lh3.googleusercontent.com/d/1VUowqpq2iQMOzz11zavwDmE2kG96jP1e=w1600",
  ],
  systemRequirements: {
    minimum: "SO: Windows 10 | Processador: Dual Core 2.5 GHz | Memória: 4 GB RAM | Placa de vídeo: Placa compatível com DirectX 11 | Armazenamento: 4 GB disponíveis",
  },
};
