...
export const DEFAULT_PLANS_CONFIG: PlansConfig = {
  pro_monthly: {
    ...
    features: [
      ...
      "🎨 Customização Total do Perfil & Fundo do Site (Wallpapers de Jogos e Cores OLED)",
      "💻 Suporte a Estilização CSS Customizada (Scoped)",
  ...
  pro_single_month: {
    ...
    features: [
      ...
      "🎨 Customização Total do Perfil, Wallpapers de Jogos e Estilização CSS",
      "Crie até 10 títulos e insígnias personalizadas",
  ...
  vip_lifetime: {
    ...
    features: [
      ...
      "Acesso PRO e VIP para toda a vida sem mensalidades",
      "🎨 Customização Total do Perfil & Site com Tema Exclusivo Obsidian Gold VIP",
      "💻 Suporte Completo a Estilização CSS, HTML & Backgrounds Próprios",
      "Crie até 10 títulos e insígnias personalizadas",
      "Selo exclusivo de Membro Fundador VIP Ouro",
