  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Barra de Ações Rápidas (Marcar todas como lidas / Limpar todas do perfil) */}
        {notifications.length > 0 && (
          <div className="px-4 py-2 border-b border-white/5 flex items-center justify-between text-xs text-neutral-400 shrink-0">
            <span>{notifications.length} {notifications.length === 1 ? "aviso" : "avisos"}</span>
            <div className="flex items-center gap-3">
              {unreadCount > 0 && (
                <button
                  type="button"
                  onClick={onMarkAllAsRead}
                  className="text-[#00E5FF] hover:underline flex items-center gap-1 font-semibold text-[11px] cursor-pointer"
                >
              ...
              {onDismissAll && (
                <button
                  ...
                  className="text-neutral-400 hover:text-red-400 hover:underline flex items-center gap-1 font-semibold text-[11px] cursor-pointer transition-colors"
                  title="Remover todos estes avisos do seu perfil"
                >
            ...
            notifications.map((notif) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Ações do Card (Link de Ação + Marcar Lido/Não Lido + Excluir) */}
                  <div className="pt-1 flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5 ml-auto">
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg border text-[11px] transition-all flex items-center gap-1 cursor-pointer active:scale-95 ${
                          isRead
