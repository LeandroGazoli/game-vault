            ...
            <div className="pt-2 flex items-center gap-2.5 flex-wrap">
              {!authUser && (
                <button
                  ...
                  className="min-h-[46px] px-5 py-2.5 rounded-2xl bg-white hover:bg-neutral-100 text-black font-extrabold text-xs flex items-center justify-center gap-2.5 transition-all shadow-xl shadow-white/10 active:scale-95 cursor-pointer"
