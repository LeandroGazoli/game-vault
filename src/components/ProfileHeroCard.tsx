            ...
            <div className="flex items-center gap-3.5 sm:gap-5 min-w-0">
              ...
              <div className="min-w-0 space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {/* Badge Gamer de Nível 1 a 99 */}
                  <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#00E5FF]/15 border border-[#00E5FF]/40 text-[#00E5FF] font-mono font-extrabold text-[10px] tracking-wide shadow-[0_0_10px_rgba(0,229,255,0.2)] shrink-0">
            ...
            <div className="pt-2 flex items-center gap-2.5 flex-wrap">
              {!authUser && (
                <button
                  ...
                  className="min-h-[46px] px-5 py-2.5 rounded-2xl bg-white hover:bg-neutral-100 text-black font-extrabold text-xs flex items-center justify-center gap-2.5 transition-all shadow-xl shadow-white/10 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
                  title="Entrar ou criar conta no MyGameList com o Google"
                >
                  {isGoogleLoading ? (
              ...
              <button
                onClick={onOpenShare}
                className="min-h-[46px] px-5 py-2.5 rounded-2xl bg-white/10 hover:bg-white/15 border border-white/15 text-xs font-semibold text-gray-200 flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer"
              >
              ...
              <Link
                href="/"
                className="min-h-[46px] px-4 py-2.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-semibold text-gray-400 hover:text-white flex items-center justify-center gap-1.5 transition-all"
              >
