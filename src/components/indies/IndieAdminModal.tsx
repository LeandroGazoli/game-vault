          ...
          initialValues={
            gameToEdit
              ? {
                  ...
                  youtubeUrl: gameToEdit.youtubeUrl,
                  tiktokUrl: gameToEdit.tiktokUrl,
                  twitterUrl: gameToEdit.twitterUrl,
                  instagramUrl: gameToEdit.instagramUrl,
                  linkedGameId: gameToEdit.linkedGameId,
                  linkedGameName: gameToEdit.linkedGameName,
                  linkedGameSlug: gameToEdit.linkedGameSlug,
                  devNotes: gameToEdit.devNotes,
                  devNotesMode: gameToEdit.devNotesMode,
