...
export default function CookieConsent() {
  ...
  return (
    <aside
      ...
      className="fixed bottom-[max(env(safe-area-inset-bottom,0px)+5.5rem,6.5rem)] sm:bottom-6 left-4 right-4 sm:left-6 sm:right-auto sm:max-w-md z-40 animate-fadeIn"
    >
