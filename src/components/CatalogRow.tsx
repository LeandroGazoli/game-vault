        ...
        >
          {games.map((game, index) => {
            ...
            return (
              <div
                key={game.id}
                className="group relative flex-shrink-0 w-36 sm:w-44 rounded-xl bg-[#12151c] border border-[#222834] hover:border-[#384255] hover:bg-[#151922] overflow-hidden flex flex-col transition-all duration-200 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/70"
              >
